...
if __name__ == '__main__':
	...
	xycar.set_xycar_position()#plus position
	...
	start_t=time.time()
	    ...
	    xycar.set_xycar_velocity(100)
	    
	    #go_back
	    sensor = xycar.get_sensor_value()
	    small = min(sensor)
	    print("sensor", small)
	    print("ANGLE:", xycar.get_xycar_steering())
	    
	    if (small < 60.0):
		print("SENSOR VALUE IS SMALL")
		xycar.set_xycar_back()		
	    else:
		print("VEL:", xycar.get_xycar_velocity())
	    #go_back end
